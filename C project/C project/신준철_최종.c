...
void SoundCredit() //음원 출처
{
	textcolor(11);
	puts("┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
	puts("┃        ▤▤ 음원    출처 ▤▤       ┃");
	puts("┃                                     ┃");
	puts("┃스위치 랜턴 버튼, 한국 저작권 위원회,┃");
	puts("┃		공유마당, CC BY       ┃");
	puts("┃                                     ┃");
	puts("┃                                     ┃");
	puts("┃폭탄이 터지는 소리, 한국저작권위원회,┃");
	puts("┃		공유마당, CC BY       ┃");
	puts("┃                                     ┃");
	puts("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
}
...
void displayMap(struct Node(*gameMap)[MAX_Y], int gameLevel, int* retMineCnt , int *life , int *score) //맵 표시
{
	...
	gotoxy(((MAX_X - gameLevel) * 2) + 3, 3);	textcolor(14);	printf("▤ 점수 : %2d    ", *score);
	gotoxy(((MAX_X - gameLevel) * 2) + 3, 4);	textcolor(14);	printf("♥ 남은 목숨 : %2d    ", *life);
	gotoxy(((MAX_X - gameLevel) * 2) + 3, 5);	textcolor(14);	printf("▤ 깃발 개수 : %2d", *retMineCnt);
	gotoxy(((MAX_X - gameLevel) * 2) + 3, 6);
	CursorView_Visible();
}
